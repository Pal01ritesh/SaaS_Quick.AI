  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        <p className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl mx-auto text-sm text-gray-600">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={() => navigate("/ai")}
          className="bg-[var(--color-primary)] text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer"
        >
          Start creating now
        </button>
      ...
      <div className= 'flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={assets.user_group} alt="people" className="h-8" />
